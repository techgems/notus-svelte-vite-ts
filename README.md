...
I am not the creator of Notus, I don't have such design capabilities, not by a long shot. All I did was to take <a href="https://github.com/creativetimofficial/notus-svelte">Notus</a>, move it to Vite instead of Rollup and allow the usage of Typescript into the template. Because I had some issues with rendering and speed on TailwindCSS I switched it to Windi CSS which plays much nicer with Vite.

Now it's the same Notus you know and love but with quality of life improvements such as Typescript support and a simpler bundler. You're welcome!

All credit regarding design and original code however goes to Creative Tim.
